    ...
    <div class="article-content">
      ...
      <div class="article-info">
        ...
        <span class="article-stats">
          <el-icon><View /></el-icon> {{ article.views || 0 }} 阅读 
          <el-icon><Star /></el-icon> {{ article.likes || 0 }} 喜欢 
          <el-icon><Collection /></el-icon> {{ article.marks || 0 }} 收藏 
          <el-icon><ChatDotRound /></el-icon> {{ article.comments || 0 }} 评论
        </span>
      </div>
